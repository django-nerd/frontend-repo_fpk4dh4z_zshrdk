  ...
  return (
    <section id="contact" className="py-24">
      <div className="max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-semibold text-gray-900">Let’s work together</h2>
        <p className="mt-3 text-gray-600">Have a project in mind or want to say hello? I’m open to freelance, full-time roles, and collaborations.</p>

        <div className="mt-8 grid grid-cols-1 gap-3 max-w-md mx-auto">
          <a href="mailto:alex@portfolio.dev" className="w-full inline-flex items-center justify-center rounded-full px-6 py-3 text-sm font-medium text-white bg-emerald-600 hover:bg-emerald-700 transition-colors">Email</a>
        ...
        <p className="mt-10 text-xs text-gray-500">© {new Date().getFullYear()} Alex — Built with React + Tailwind</p>
      </div>
    </section>
  )
}
